...
module.exports = class CachePolicy {
    ...
    constructor(
        ...
        const hasAuthorization = Object.keys(req.headers || {}).some((key) => key.toLowerCase() === 'authorization' && req.headers[key]);
        this._noAuthorization = !hasAuthorization;
    ...
    _varyMatches(req) {
        ...
        const varyHeader = String(this._resHeaders.vary);
        if (varyHeader.split(',').some((part) => part.trim() === '*')) {
            return false;
        }
